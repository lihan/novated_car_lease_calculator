...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    monthlyTakeHomeDecrease: 'ESTIMATED MONTHLY TAKE-HOME PAY DECREASE',
    month: 'month',
    impactDescription:
    ...
    annualTakeHomeDecrease: 'Annual take-home decrease',
    ...
    taxGstSavings: 'Tax & GST savings',
    allAmountsAud: 'All amounts in AUD',
    duringLease: 'During your lease',
    monthly: 'Monthly',
    annual: 'Annual',
    wholeTerm: 'Whole term',
    includedFinanceInterest: 'Included finance interest:',
    finalResidual: 'Final residual:',
    benefitComponent: 'Benefit component',
    oneOff: 'One-off',
    totalEstimatedBenefit: 'Total estimated tax + GST benefit',
    overYears: 'Over years',
    savingsNote:
      'Income-tax attribution applies vehicle costs first, then energy, then other costs. Each step uses progressive tax. Residual GST and contribution GST are deducted to avoid overstating savings.',
  ...
  zh: {
    ...
    monthlyTakeHomeDecrease: '预计每月到手工资减少',
    month: '每月',
    ...
    annualTakeHomeDecrease: '年度到手工资减少',
    ...
    costBreakdown: '成本明细',
    taxGstSavings: '税务与 GST 节省',
    allAmountsAud: '所有金额均为澳元',
    duringLease: '租赁期间',
    monthly: '每月',
    annual: '每年',
    wholeTerm: '整个期限',
    includedFinanceInterest: '包含的融资利息：',
    finalResidual: '最终残值：',
    benefitComponent: '收益组成',
    oneOff: '一次性',
    totalEstimatedBenefit: '预计税务 + GST 总收益',
    overYears: '年合计',
    savingsNote:
      '所得税归因先应用于车辆成本，再应用于能源，最后应用于其他成本。每一步都使用累进税率。扣除残值 GST 和员工缴款 GST，避免高估节省。',
...
const textTranslations: Record<string, string> = {
  ...
  'Vehicle / lease + administration income tax': '车辆 / 租赁 + 管理费所得税',
  'Charging / fuel income tax': '充电 / 燃油所得税',
  'Insurance + other running-cost income tax': '保险 + 其他运行成本所得税',
  'Medicare levy': 'Medicare levy',
  'Vehicle acquisition GST credit (once)': '车辆购置 GST 抵免（一次性）',
  'Running-cost GST credits': '运行成本 GST 抵免',
  'Administration GST credits': '管理费 GST 抵免',
  'Employee-contribution GST remitted': '员工缴款代缴 GST',
...
export function translateBreakdownLabel(locale: Locale, label: string): string {
